...
if (i > 0) {
  ...
  this_time <- raster(paste0(model,"/rep",replicate,"_",i,"s.tif"))
  last_time <- raster(paste0(model,"/rep",replicate,"_",i2,"s.tif"))
  ...
  write.table(maketext, file=paste0("Output_specialist1000/nodes_",model,replicate,"yr",i,".txt"), sep = "\t", row.names = FALSE, col.names = FALSE)
  rm(pol8)
  rm(pol5)
  rm(a)
  rm(b)
...
write.table(costcomplete, file=paste0("Output_specialist1000/distance_",model,replicate,"yr",i,".txt"), sep = "\t", row.names = FALSE, col.names = FALSE)
...
write.table(results, file=paste0("Output_specialist1000/Metrics_",model,replicate,"yr",i,".txt"), sep = "\t", row.names = TRUE, col.names = TRUE)
