...
#models<- c("economic","geodiversity")
...
if (i > 0) {
  ...
  write.table(maketext, file=paste0("Output_specialist5000/nodes_",model,replicate,"yr",i,".txt"), sep = "\t", row.names = FALSE, col.names = FALSE)
  rm(pol8)
  rm(pol5)
  rm(a)
  rm(b)
...
write.table(costcomplete, file=paste0("Output_specialist5000/distance_",model,replicate,"yr",i,".txt"), sep = "\t", row.names = FALSE, col.names = FALSE)
...
write.table(results, file=paste0("Output_specialist5000/Metrics_",model,replicate,"yr",i,".txt"), sep = "\t", row.names = TRUE, col.names = TRUE)
